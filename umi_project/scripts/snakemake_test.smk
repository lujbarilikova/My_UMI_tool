REF_DIR = "references/homsap/GRCh38-p10"          # choose your reference directory
WDIR = "umi_project"                              # choose working directory
#sample_list = ["L102-Q_SE","L102FFPE-Q_SE"]       # make list of samples  
#sample_list = [dataset1,"dataset2","dataset3","dataset4","dataset5","dataset6"]
sample_list = [dataset]
...
rule alignment_SE:
    input:  fastq = WDIR + "/{type}_fastq/{sample}.fastq.gz",
